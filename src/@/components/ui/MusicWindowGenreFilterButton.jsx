...
const MusicWindowGenreFilterButton = ({genre, handleUnselect}) => {
  ...
  return (
    <div>
      <Button variant='outline' className='h-8 text-[#262626] round-md border-[#656565] border font-normal pr-2 mr-2 cursor-default bg-[#FFDE5A] hover:bg-[#FFDE5A] font-semibold'>
        {genre}
        <XCircle
